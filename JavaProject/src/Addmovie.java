...
public class Addmovie extends javax.swing.JFrame {
    ...
    // Logger used to track unexpected runtime issues in this form.
     ...
     */
    public Addmovie() {
        // Build and place all Swing components generated by NetBeans.
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        // Read all user inputs from the form before any validation.
        ...
        // Convert numeric text fields to Java numeric types.
        ...
        if (Movie.movieExists(moviename)) {
            // Stop creation if the movie name already exists in the database.
        ...
        // Price and discount are read from the form fields
        // Create a domain object that contains all values from the form.
        Movie newmovie = new Movie(moviename, genre, publicationdate, urltrailer, runningtime, price, discount, picture);

        // Persist the movie and get the operation status.
        boolean success = newmovie.addMovie();

        if (!success) {
            // Show a database error and stop if insertion failed.
            JOptionPane.showMessageDialog(this,
    ...
    private void jTextField5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField5ActionPerformed
        // Action hook for Running time field (currently no extra behavior).
    }//GEN-LAST:event_jTextField5ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // Return to the movie registry screen.
        new MovieRegister().setVisible(true);
        // Close the current window to avoid stacking multiple frames.
        this.dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jTextField8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField8ActionPerformed
        // Unused field action generated by the form editor.
    }//GEN-LAST:event_jTextField8ActionPerformed

    private void jTextField9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField9ActionPerformed
        // Action hook for Discount price field (currently no extra behavior).
    ...
    public static void main(String args[]) {
        ...
        // Start the UI on the Event Dispatch Thread, as required by Swing.
